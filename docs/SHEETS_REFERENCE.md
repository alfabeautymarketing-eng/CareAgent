...
| RULES | Правила синхро (deprecated) | Лист больше не используется, правила на сервере | — | — | — |
| LOG | Логи | Сессионный лог операций (сервер + GAS) | ✓ | ✓ | ✓ |
| SYNC_LOG | Журнал синхро | Лог примененных правил синхронизации | ✓ | ✓ | ✓ |
